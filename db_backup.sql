...
CREATE TABLE `dept` (
  ...
  `budget` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`dno`,`dname`,`budget`)
...
CREATE TABLE `emp` (
  ...
  `ename` char(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `dno` char(4) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `salary` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`eno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `emp` VALUES ('E1','Lopez','D1','40K'),('E2','Cheng','D1','42K'),('E3','Finzi','D2','30K'),('E4','Saito','D2','35K');
...
INSERT INTO `spj` VALUES ('S1','P1','J1',200),('S1','P1','J4',700),('S2','P3','J1',400),('S2','P3','J2',200),('S2','P5','J2',100),('S2','P3','J3',200),('S2','P3','J4',500),('S2','P3','J5',600),('S2','P3','J6',400),('S2','P3','J7',800),('S3','P3','J1',200),('S3','P4','J5',500),('S4','P6','J3',300),('S4','P6','J7',300),('S5','P2','J2',200),('S5','P6','J2',200),('S5','P1','J4',100),('S5','P2','J4',100),('S5','P3','J4',200),('S5','P4','J4',800),('S5','P5','J4',400),('S5','P6','J4',500),('S5','P5','J5',500),('S5','P5','J7',100);
...
-- Dump completed on 2023-11-13 13:59:25
